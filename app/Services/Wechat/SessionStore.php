...
class SessionStore
{
     ...
     */
    public function issue(User $user, string $appid, string $sessionKey, int $wxUserId): array
    {
        ...
        return ['token' => $token, 'expires_in' => self::TTL];
    }

    /**
     * @return array{user_id: int, wx_user_id: int, appid: string, session_key: string}|null
     */
